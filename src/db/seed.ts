...
async function main() {
  ...
  if (!existingProperty) {
    const property = await Property.create({
      ...
      furnishingsInventory: [
        { key: 'FANS', qty: 5 },
        { key: 'EXHAUST_FANS', qty: 3 },
        { key: 'GEYSERS', qty: 3 },
        { key: 'STOVE', qty: 1 },
        { key: 'LIGHTS', qty: 8 },
        { key: 'CURTAINS', qty: 1 },
        { key: 'MODULAR_KITCHEN', qty: 1 },
        { key: 'CHIMNEY', qty: 1 },
        { key: 'WARDROBES', qty: 3 },
        { key: 'AC_SPLIT', qty: 3 },
        { key: 'SMART_LOCK', qty: 1 },
      ],
      amenities: [
        'GYMNASIUM',
        'SWIMMING_POOL',
      ...
      nearbyPlaces: [
        { name: 'Sector 55-56 Metro', distance: '1.8 km', category: 'METRO' },
        { name: 'Pathways School', distance: '2.1 km', category: 'SCHOOL' },
        { name: 'Medanta Hospital', distance: '4.5 km', category: 'HOSPITAL' },
        { name: 'Good Earth City Centre', distance: '1.2 km', category: 'MARKET' },
        { name: 'Golf Course Ext. Road', distance: '0.6 km', category: 'HIGHWAY' },
      ],
  ...
  if (!liveProperty) {
    const live = await Property.create({
      ...
      nearbyPlaces: [
        { name: 'MG Road Metro', distance: '2.4 km', category: 'METRO' },
        { name: 'The Heritage School', distance: '1.5 km', category: 'SCHOOL' },
        { name: 'Fortis Memorial', distance: '3.2 km', category: 'HOSPITAL' },
        { name: 'DT Mega Mall', distance: '1.1 km', category: 'MARKET' },
        { name: 'NH-48', distance: '2.0 km', category: 'HIGHWAY' },
      ],
